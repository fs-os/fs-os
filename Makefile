...
# todo comment.
$(KERNEL_BIN): cfg/linker.ld obj/kernel/boot.o obj/kernel/kernel.o obj/kernel/tty.o sysroot_headers sysroot_lib
...
obj/kernel/tty.o: src/kernel/tty.c sysroot_headers
	@mkdir -p obj/kernel/
	$(CC) --sysroot=sysroot -isystem=/usr/include -c $< -o $@ -O2 -ffreestanding -std=gnu11 $(CFLAGS) -Iinclude
